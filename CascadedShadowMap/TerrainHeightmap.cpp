...
void HeightmapGen::GenerateBlock(XMMATRIX worldMatrix, ID3D12Resource* destResource, ID3D12Heap* heap) {

	D3D12_TILED_RESOURCE_COORDINATE tiledCoordinate = {};
...
void HeightmapGen::GenerateInitialTiles(XMMATRIX* worldMatrices, UINT nMatrices, ID3D12Resource* destResource, ID3D12Heap* heap) {
...
void HeightmapGen::Generate4KChunk(XMMATRIX worldMatrix, ID3D12Resource* destResource, ID3D12Heap* heap) {
